...
```powershell
pythonw "C:\Users\choi2\.codex\skills\algeomath\scripts\stackblocks_harness.py" `
  --blocks '[[x,y,z], ...]' `
...
```powershell
python "C:\Users\choi2\.codex\skills\algeomath\scripts\stackblocks_harness.py" --preset reference-pyramid --print-coordinates
```
